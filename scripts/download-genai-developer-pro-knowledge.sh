...
echo "Downloading AWS Well Architected Framework - Responsible AI Lens ... "
wget -O knowledge-files/responsible-ai-lense.pdf https://docs.aws.amazon.com/pdfs/wellarchitected/latest/responsible-ai-lens/responsible-ai-lens.pdf#responsible-ai-lens --no-check-certificate
